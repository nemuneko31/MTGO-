/* ============================================================
   ...
   - v8.0.0: 旧CPU後付け層を撤去し、単一状態機械としてCPU実行基盤・統合対戦開始・開始前マリガン・優先権・スタック・戦闘・ターン進行を再構築
...
const APP_RELEASE = "9.2.0-cpu-control-card-automation";
const PREVIOUS_APP_RELEASE = "9.1.0-core-turn-combat-fix";
